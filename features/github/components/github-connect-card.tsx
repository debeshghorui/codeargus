...
import { getGithubAppInstallationUrl } from "@/features/github/utils/github-app";
    ...
    return (
        ...
        >
            <a href={installUrl}>
                ...
                Install GitHub App
                <HugeiconsIcon icon={ExternalLinkIcon} strokeWidth={2} className="size-3 opacity-80" />
            </a>
        </Button>
    );
}
